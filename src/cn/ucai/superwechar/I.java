...
public interface I {
	...
	String AVATAR_PATH = "C:/superwechatDB-20160518/superwechatDB/user_avatar/";
	...
	String MSG_PREFIX_MSG = "msg_";                          //返回的消息吗前缀
	 ...
	 * 下载用户头像的网络请求
	 */
	String REQUEST_DOWNLOAD_AVATAR_USER  =superwecharApplication.SERVER_ROOT+"?"+KEY_REQUEST+"="
			+REQUEST_DOWNLOAD_AVATAR+"&"+AVATAR_TYPE+"=";
	/**
	 * 下载群组的网络请求
	 */
	String REQUSET_DOWNLOAD_AVATAR_GROUP   = superwecharApplication.SERVER_ROOT+"?"
